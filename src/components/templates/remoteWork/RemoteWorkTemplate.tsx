...
export function RemoteWorkTemplate({ resumeData, contentRef, className }: TemplateProps) {
  ...
  return (
    <Card>
      <CardContent className="p-4  bg-gray-100 rounded-lg">
        <h2 className="text-lg font-semibold mb-3 bg-gray-200" style={{ color: colorHex }}>Information</h2>
...
function ExperienceSection({ resumeData }: SectionProps) {
  ...
  return (
    <Card>
      <CardContent className="p-4">
        <h2 className="text-lg font-semibold mb-3 bg-gray-100" style={{ color: colorHex }}>Experience</h2>
  ...
  return (
    <Card>
      <CardContent className="p-4  bg-gray-100 overflow-hidden">
        <h2 className="text-lg font-semibold mb-3 bg-gray-200" style={{ color: colorHex }}>Expertise</h2>
